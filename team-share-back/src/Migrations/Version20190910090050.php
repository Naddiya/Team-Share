 ...
 */
final class Version20190910090050 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, job_title VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, city VARCHAR(100) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, score INT DEFAULT NULL, photo LONGTEXT DEFAULT NULL, description LONGTEXT NOT NULL, is_active TINYINT(1) NOT NULL, url_facebook LONGTEXT DEFAULT NULL, url_github LONGTEXT DEFAULT NULL, url_twitter LONGTEXT DEFAULT NULL, url_linkedin LONGTEXT DEFAULT NULL, username VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D649D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
