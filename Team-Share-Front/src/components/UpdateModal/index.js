...
import { Modal, Button, Icon, Form, Header } from 'semantic-ui-react'
    ...
    return (
        <Modal size="small" trigger={<Button className="submit" color="blue">Modifier mon profil</Button>} closeIcon>
            ...
            <Modal.Content>
                ...
                <Form.Dropdown onChange={handleChangeSkills} fluid multiple selection placeholder="Compétences" options={technos} />
            </Modal.Content>
            <Modal.Actions>
